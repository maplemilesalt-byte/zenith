...
int main(int argc,char**argv){
 ...
 constexpr std::uint64_t fb=0x800000,fbBytes=320ull*240ull*4ull;
 if(elfMode){
  if(graphicsMode&&!memory.map(fb,fb,fbBytes,GuestMemory::Permissions::Read|GuestMemory::Permissions::Write)){std::cerr<<"Failed to map guest framebuffer.\n";return 1;}
